...
const orderSchema = new mongoose.Schema(
  {
    ...
    hubDbName: { type: String, default: null },
    ...
    ftwInventoryReservationId: { type: String, default: null },
    ftwInventoryReservationExpiresAt: { type: Date, default: null },
    ftwInventoryHeartbeatAt: { type: Date, default: null },
    ftwInventoryAllocationLedger: { type: mongoose.Schema.Types.Mixed, default: [] },
...
const pendingCheckoutSchema = new mongoose.Schema(
  {
    ...
    checkoutAttemptId: { type: String, default: null, index: true },
    orderPayload: { type: mongoose.Schema.Types.Mixed, required: true },
    ftwInventoryState: { type: String, default: "none" },
    ftwInventoryOperationId: { type: String, default: null },
    ftwInventoryReservationId: { type: String, default: null },
    ftwInventoryReservationExpiresAt: { type: Date, default: null, index: true },
    ftwInventoryHeartbeatAt: { type: Date, default: null },
    ftwInventoryAllocationLedger: { type: mongoose.Schema.Types.Mixed, default: [] },
    ftwInventoryRestoreOperationId: { type: String, default: null },
    ftwInventoryOrderId: { type: String, default: null },
